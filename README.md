...
Прокси-сервер для работы с Telegram API. Принимает HTTPS-запросы от сервера в РФ и форвардит их в Telegram, а также принимает вебхуки от Telegram и пересылает на РФ-сервер. Не требуется домен.
